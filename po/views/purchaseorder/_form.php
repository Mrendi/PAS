...
<div class="purchase-order-form">
       ...
       <legend>Purchase Order</legend>
        ...
        <div class="row">
            <div class="col-md-5">
                ...
                <?= $form->field($model->purchaseorder, 'wo_number')->textInput(['maxlength' => true])->hiddenInput()->label(false) ?>
                <?= Html::label('Nama Supplier') ?>
                 <?= Html::input('text', 'supplier-name', $model->purchaseorder->supplier_code, ['class' => 'form-control', 'id' => "po-supplier-name",'readonly' => "true"]) ?>   
                <?= $form->field($model->purchaseorder, 'supplier_code')->textInput(['maxlength' => true])->hiddenInput()->label(false) ?> 
            ...
            <div class="col-md-5">
                ...
                <?= $form->field($model->purchaseorder, 'shipment_date')->widget(DatePicker::classname(), [
    ...
    <br><br>
     ...
     <fieldset>
        ...
        echo '<thead>';
        echo '<tr>';
        echo '<th>' . $purchaseorderdetail->getAttributeLabel('nama_item') . '</th>';
        echo '<th></th>';
        echo '<th>' . $purchaseorderdetail->getAttributeLabel('jumlah') . '</th>';
        echo '<th>' . $purchaseorderdetail->getAttributeLabel('keterangan') . '</th>';
