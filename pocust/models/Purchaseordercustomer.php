 ...
 */
class Purchaseordercustomer extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['pocust_number'], 'required'],
            [['pocust_date', 'wo_number', 'shipment_date', 'created_date', 'modified_date'], 'safe'],
            [['total_pocust'], 'number'],
            [['is_active'], 'boolean'],
...
*/
     ...
     */
    public function getPurchaseordercustomerdetails()
    {
        return $this->hasMany(Purchaseordercustomerdetail::className(), ['id_pocust_header' => 'id']);
    }
